                    ...
                    <div class="container">
                        <div class="card shadow-lg p-0 mb-5 bg-white rounded" style="max-width: 18rem;">
                            <div class="card-body">
                                ...
                                <c:if test="${not empty tipoAp}">
                                <div class="row">
                                  <div class="col-md-12">
                                    <a class="btn btn-success" href="http://localhost:8080/PI_GaleriaRua/pg_cadastroApreciador">Voltar</a>
                                  </div>
                                </div>
                                </c:if>
                                <c:if test="${not empty tipoArt}">
                                <div class="row">
                                  <div class="col-md-12">
                                    <a class="btn btn-success" href="http://localhost:8080/PI_GaleriaRua/pg_cadastroArtistaFotografo">Voltar</a>
                                  </div>
                                </div>
                                </c:if>
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    <a class="btn btn-success" href="http://localhost:8080/PI_GaleriaRua/pg_login">Voltar</a>
                                  </div>
                                </div>
                                </c:if>
                                <c:if test="${not empty usuarioExcluido}">
                                <div class="row">
                                  <div class="col-md-12">
                                    <a class="btn btn-success" href="http://localhost:8080/PI_GaleriaRua/ListaUsuario">Voltar</a>
                                  </div>
                                </div>
                                </c:if>
                                <c:if test="${not empty usuarioModificado}">
                                <div class="row">
                                  <div class="col-md-12">
                                    <a class="btn btn-success" href="http://localhost:8080/PI_GaleriaRua/ListaUsuario">Voltar</a>
                                  </div>
                                ...
                                <c:if test="${not empty usuarioModificado2}">
                                <div class="row">
                                  <div class="col-md-12">
                                    <a class="btn btn-success" href="http://localhost:8080/PI_GaleriaRua/pg_artistaFoto">Voltar</a>
                                  </div>
                                </div>
                                </c:if>
                                <c:if test="${not empty criaObra}">
                                <div class="row">
                                  <div class="col-md-12">
                                    <a class="btn btn-success" href="http://localhost:8080/PI_GaleriaRua/pg_cadastroObra">Voltar</a>
                                  </div>
                                </div>
                                </c:if>
                                <c:if test="${not empty obraExcluida}">
                                <div class="row">
                                  <div class="col-md-12">
                                    <a class="btn btn-success" href="http://localhost:8080/PI_GaleriaRua/pg_artistaFoto">Voltar</a>
                                  </div>
                                ...
                                <c:if test="${not empty obraExcluidaGerente}">
                                <div class="row">
                                  <div class="col-md-12">
                                    <a class="btn btn-success" href="http://localhost:8080/PI_GaleriaRua/ListaUsuario">Voltar</a>
                                  </div>
