        ...
        <div class="row my-5 mb-5">    
            ...
            <div class="col-10">
                <div class="mx-auto col-lg-12 col-15">
                    ...
                    <form role="form" action="ModificaArtista?cod_usuario=${cod_usuario}" method="POST">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="was-validated"> 
                                ...
                                <input type="text" class="form-control" name="linguagem" required placeholder="${linguagem}" required> 
                            </div>
                            ...
                            <div class="form-group was-validated"> 
                                ...
                                <textarea class="form-control" name="descricao_artist_foto" rows="3" 
                                          placeholder="${desc_artist_foto}" required></textarea>
                                <div class="form-check"> 
                                    <!-- 
                                    <input class="form-check-input" type="checkbox" id="descricao_artist_foto" value="on">
                                    <label class="form-check-label" for="form21">Eu concordo com os termos e serviços</label>
                                    -->
                                </div>
                            </div>
